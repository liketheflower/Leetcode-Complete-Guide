...
#1634. [ Add Two Polynomials Represented as Linked Lists (M-) 1400](./code/1634.txt) <br />
...
#LCP27. [ 黑盒光线反射   (H+) 2300](./code/LCP27.txt) <br />
...
---
 ...
 #POJ 2479. [Maximum sum (M+) 1600](./code/POJ2479.txt) <br />
 ...
 ***一个不错新的面试刷题网站***<br/>
 ...
 #B26. [Longest Palindromic Subsequence  (H-) 1700](./code/b26.txt) <br />
 #B27. [LCS  (M) 1500](./code/b27.txt) <br />
 ...
 #B76. [Making Coin Change (M-) 1300](./code/b76.txt) <br />
 ...
 #B193. [Sum Tree  (M-) 1300](./code/b193.txt) <br />
 #B200. [Odd number of digits  (E-) 800](./code/b200.txt) <br />
 #B207. [Mad Max  (H-) 1700](./code/b207.txt) <br />
 #B217. [Longest common subsequence of three strings  (H) 1800](./code/b217.txt) <br />
 #B251. [Largest tree sum path  (M+) 1600](./code/b251.txt) <br />
 #B277. [Unique Characters of Every Substring (H) 1800](./code/b277.txt) <br />
 ...
 #B390. [Range Update (M)1500](./code/b390.txt) <br />
 ...
 #B689. [Number of K-Length Sublists with Average at Least Target (M-)1300](./code/b689.txt) <br />
 ...
 B. [Bets (1200) ](./contest/BETA63B.txt) <br />
 D. [Dot (1900) (Game+Dp)](./contest/BETA63D.txt) <br />
 ...
 E. [Pluses everywhere (2200)  (Math+组合数学) ](./code/295E.txt) <br />
 ...
 F. [DIY Garland (2200)    (Greedy+Tree+Heap)](./code/611F.txt) <br />
   ...
   F. [Moving Point (1900)  Segment Tree](./code/624F.txt) <br />
 ...
 <br><br><br>
  ...
  709A. [ Juicer (900) ](./code/709A.txt) <br />
  ...
  721C. [ Journey	 (1800) (Graph) ](./code/721C.txt) <br />
   ...
   415D. [Mashmokh and ACM (1400) (dp) ](./code/415D.txt) <br />
  ...
  1435C. [Perform Easily	(1900) Sort+Greedy+Sliding Window](./code/1435C.txt) <br />
